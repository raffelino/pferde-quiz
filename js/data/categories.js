...
export const CATEGORIES = [
  ...
  { id: 'reitlehre',  name: 'Reitlehre & Sitz',             emoji: '🏇' },
  { id: 'hilfen',     name: 'Hilfengebung & Paraden',       emoji: '🤲' },
  { id: 'gangarten',  name: 'Grundgangarten & Fußfolge',    emoji: '🐎' },
  { id: 'ausbildung', name: 'Ausbildungsskala & -weg',      emoji: '🔺' },
